...
namespace ThinkGeo.UI.Blazor.HowDoI
{
    public class ThematicDemographicStyleBuilder : DemographicStyleBuilder
    {
            ...
            : base(selectedColumns)
        {
            ...
            this.Color = GeoColors.LightBlue;
            this.EndColor = GeoColors.LightRed;
        ...
        protected override Style GetStyleCore(FeatureSource featureSource)
        {
            ...
            {
                ClassBreak classBreak = new ClassBreak(classBreakValues[i], new AreaStyle(new GeoPen( GeoColor.FromHtml("#f05133"), 1), new GeoSolidBrush(new GeoColor(this.Opacity, familyColors[i]))));
