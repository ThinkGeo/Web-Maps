...
A demonstration of how to use printing with ThinkGeo UI for WebApi that can be added to your projects.

![Screenshot](https://gitlab.com/thinkgeo/public/thinkgeo-web-maps/-/raw/master/samples/web-api/PrintingSample/ScreenShot.png)
