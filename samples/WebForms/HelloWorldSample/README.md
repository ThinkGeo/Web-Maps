...
![Screenshot](https://github.com/ThinkGeo/HelloWorldSample-ForWebForms/blob/master/Screenshot.gif)
...
Map1.StaticOverlay.Layers.Add(new WorldStreetsAndImageryRasterLayer());
