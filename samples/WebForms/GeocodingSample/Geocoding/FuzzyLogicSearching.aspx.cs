...
{
    public partial class FuzzyLogicSearching : System.Web.UI.Page
    {
        ...
        private void PopulateAddressResultList(Collection<GeocoderMatch> matchResult)
        {
            ...
            {
                if (matchItem.NameValuePairs.ContainsKey("DT_City") && matchItem.NameValuePairs.ContainsKey("DT_State"))
                {
                    lstResult.Items.Add(SampleHelper.GetMatchItemText(matchItem, new string[] { "DT_City", "DT_State" }));
                }
            }
