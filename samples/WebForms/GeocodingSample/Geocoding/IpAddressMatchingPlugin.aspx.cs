...
{
    public partial class IpAddressMatchingPlugin : System.Web.UI.Page
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            var dataPath = this.GetDataPath("IpAddress");
        ...
        private void PopulateAddressResultList(Collection<GeocoderMatch> matchResult)
        {
            ...
            foreach (GeocoderMatch matchItem in matchResult)
            {
                ...
                {
                    lstResult.Items.Add(SampleHelper.GetMatchItemText(matchItem, new string[] { "IP", "Country" }));
                }
