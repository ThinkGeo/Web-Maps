<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateDatabaseMatchingPlugIn.aspx.cs"
    Inherits="ThinkGeo.MapSuite.HowDoI.CreateDatabaseMatchingPlugIn" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <Description:DescriptionPanel ID="descriptionPanel1" Height="600" runat="server">
                This sample demonstrates how to create a AccessMatchingPlugIn for USA counties.
