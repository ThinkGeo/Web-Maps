...
{
    public partial class CreateAGraticuleAdornmentLayer : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                LayerOverlay graticuleAdornmentLayerOverlay = new LayerOverlay();
                graticuleAdornmentLayerOverlay.TileType = TileType.SingleTile;
                graticuleAdornmentLayerOverlay.IsBaseOverlay = false;
                graticuleAdornmentLayerOverlay.Layers.Add(graticuleAdornmentLayer);

                Map1.CustomOverlays.Add(graticuleAdornmentLayerOverlay);
            }
        }
    }
}
