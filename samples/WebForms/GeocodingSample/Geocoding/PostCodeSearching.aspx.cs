...
{
    public partial class PostCodeSearching : System.Web.UI.Page
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            var dataPath = this.GetDataPath("PostCode");
        ...
        private void PopulateAddressResultList(Collection<GeocoderMatch> matchResult)
        {
            ...
            foreach (GeocoderMatch matchItem in matchResult)
            {
                ...
                {
                    lstResult.Items.Add(SampleHelper.GetMatchItemText(matchItem, new string[] { "PostCode", "PlaceName", "Admin Level 1" }));
                }
