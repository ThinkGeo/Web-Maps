...
|[`Layers`](#layers)|GeoCollection<[`AdornmentLayer`](../ThinkGeo.Core/ThinkGeo.Core.AdornmentLayer.md)>|A collection of|
...
|Name|Type|Description|
|---|---|---|
|canvas|[`GeoCanvas`](../ThinkGeo.Core/ThinkGeo.Core.GeoCanvas.md)|This parameter specifies the target canvas to draw the current AdornmentOverlay on.|
