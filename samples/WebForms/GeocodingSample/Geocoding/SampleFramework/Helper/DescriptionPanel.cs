...
namespace ThinkGeo.MapSuite.HowDoI
{
    ...
    public class DescriptionPanel : Panel
    {
        ...
        {
            StreamReader reader = File.OpenText(Page.MapPath("~/SampleFramework/helper/DescriptionPanel.js"));
        ...
        {
            StreamReader reader = File.OpenText(Page.MapPath("~/SampleFramework/helper/DescriptionPanel.htm"));
