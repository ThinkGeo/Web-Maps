...
{
    public partial class Censusblock : System.Web.UI.Page
    {
        ...
        private void PopulateAddressResultList(Collection<GeocoderMatch> matchResult)
        {
            ...
            foreach (GeocoderMatch matchItem in matchResult)
            {
                ...
                {
                    lstResult.Items.Add(SampleHelper.GetMatchItemText(matchItem, new string[] { "ID_Block", "State", "County", "TractCE" }));
                }
            }
