...
namespace Visualization
{
    public static class OverlayBuilder
    {
        ...
        public static LayerOverlay GetOverlayWithClassBreakStyle()
        {
            ...
            string shpFilePathName = Path.Combine(baseDirectory, "usStatesCensus2010.shp");
            ...
            shapeFileFeatureLayer.FeatureSource.ProjectionConverter = new ProjectionConverter(4326, 3857);
        ...
        {
            // Get the file path name from its relative path.
            string shpFilePathName = Path.Combine(baseDirectory, "usEarthquake.shp");
        ...
        public static LayerOverlay GetOverlayWithDotDensityStyle()
        {
            ...
            ShapeFileFeatureLayer shapeFileFeatureLayer = new ShapeFileFeatureLayer(shpFilePathName);
            shapeFileFeatureLayer.ZoomLevelSet.ZoomLevel01.CustomStyles.Add(AreaStyle.CreateSimpleAreaStyle(GeoColor.FromArgb(20, GeoColor.FromHtml("#00e6fe")), GeoColors.Gray));
            // Create the DotDensityStyle
            DotDensityStyle dotDensityStyle = new DotDensityStyle("Population", 0.0000094778167166538189, PointStyle.CreateSimpleCircleStyle(GeoColors.Black, 7));
        ...
        public static LayerOverlay GetOverlayWithFilterStyle()
        {
            ...
            filterStyle.Styles.Add(AreaStyle.CreateSimpleAreaStyle(GeoColor.FromArgb(130, GeoColor.FromHtml("#ffb74c")), GeoColor.FromHtml("#333333")));
        ...
        public static LayerOverlay GetOverlayWithHeatStyle()
        {
            ...
            ShapeFileFeatureLayer shapeFileFeatureLayer = new ShapeFileFeatureLayer(shpFilePathName);
            shapeFileFeatureLayer.ZoomLevelSet.ZoomLevel01.ApplyUntilZoomLevel = ApplyUntilZoomLevel.Level20;
            shapeFileFeatureLayer.ZoomLevelSet.ZoomLevel01.CustomStyles.Add(new HeatStyle(10, 150, "MAGNITUDE", 0, 12, 100, DistanceUnit.Kilometer, GeoColors.Aqua));
        ...
        {
            // Get the file path name from its relative path.
            string shpFilePathName = Path.Combine(baseDirectory, "Vehicles.shp");
        ...
        //    TextStyle textStyle = TextStyle.CreateSimpleTextStyle("AREANAME", "Arial", 10, DrawingFontStyles.Regular, GeoColors.Black, GeoColors.White, 2, -20, 40);
        ...
        private static ClassBreakStyle GetClassBreakStyle()
        {
            ...
            {
                classBreakStyle.ClassBreaks.Add(new ClassBreak(classBreakValues[i], AreaStyle.CreateSimpleAreaStyle(new GeoColor(150, familyColors[i]), GeoColor.FromHtml("#f05133"), 1)));
            }
        ...
        private static ClassBreakClusterPointStyle GetClusterPointStyle()
        {
            ...
            PointStyle pointStyle5 = new PointStyle(PointSymbolType.Circle, 49, new GeoSolidBrush(GeoColor.FromArgb(250, 245, 7, 10)), new GeoPen(GeoColor.FromArgb(100, 245, 7, 10), 15));
        ...
        private static Collection<FeatureLayer> GetCustomStyleLayers()
        {
            ...
            string[] temperatureIcons = new string[] {
                Path.Combine(baseDirectory, "CustomStyles","offset_circle_red_bl.png"),
                Path.Combine(baseDirectory, "CustomStyles","offset_triangle_blue_revert.png")};
            ...
            inMemoryFeatureLayerColdFront.ZoomLevelSet.ZoomLevel03.CustomStyles.Add(coldFrontLineStyle);
            inMemoryFeatureLayerColdFront.ZoomLevelSet.ZoomLevel03.ApplyUntilZoomLevel = ApplyUntilZoomLevel.Level20;
            featureLayers.Add(inMemoryFeatureLayerColdFront);
            // Add features which present the cold points.
            inMemoryFeatureLayerColdFront.InternalFeatures.Add(new Feature(File.ReadAllText(Path.Combine(baseDirectory, "CustomStyles", "ColdFront2.txt"))));
            inMemoryFeatureLayerColdFront.InternalFeatures.Add(new Feature(File.ReadAllText(Path.Combine(baseDirectory, "CustomStyles", "ColdFront3.txt"))));

            InMemoryFeatureLayer inMemoryFeatureLayerWarmFront = new InMemoryFeatureLayer();
            // Warm Front Icon Style.
            CustomGeoImageLineStyle warmFrontLineStyle = new CustomGeoImageLineStyle(lineStyle, new GeoImage(Path.Combine(baseDirectory, "CustomStyles", "offset_circle_blue.png")), 30, ImageDirection.Right);
            inMemoryFeatureLayerWarmFront.ZoomLevelSet.ZoomLevel03.CustomStyles.Add(warmFrontLineStyle);
            inMemoryFeatureLayerWarmFront.ZoomLevelSet.ZoomLevel03.ApplyUntilZoomLevel = ApplyUntilZoomLevel.Level20;
            featureLayers.Add(inMemoryFeatureLayerWarmFront);
            // Add features which present the warm points.
            LineShape lineShape5 = new LineShape(File.ReadAllText(Path.Combine(baseDirectory, "CustomStyles", "WarmFront5.txt")).Trim());
            inMemoryFeatureLayerWarmFront.InternalFeatures.Add(new Feature(lineShape5));
            LineShape lineShape6 = new LineShape(File.ReadAllText(Path.Combine(baseDirectory, "CustomStyles", "WarmFront6.txt")).Trim());
            inMemoryFeatureLayerWarmFront.InternalFeatures.Add(new Feature(lineShape6));
            LineShape lineShape7 = new LineShape(File.ReadAllText(Path.Combine(baseDirectory, "CustomStyles", "WarmFront7.txt")).Trim());
            inMemoryFeatureLayerWarmFront.InternalFeatures.Add(new Feature(lineShape7));
            LineShape lineShape8 = new LineShape(File.ReadAllText(Path.Combine(baseDirectory, "CustomStyles", "WarmFront8.txt")).Trim());
            ...
            CustomGeoImageLineStyle occludedFrontLineStyle = new CustomGeoImageLineStyle(lineStyle, new[]
                {
                    new GeoImage(Path.Combine(baseDirectory,"CustomStyles","offset_triangle_and_circle_blue.png")),
                    new GeoImage(Path.Combine(baseDirectory,"CustomStyles","offset_triangle_and_circle_red.png"))
                }, 45, ImageDirection.Right);
            inMemoryFeatureLayerOccludedFront.ZoomLevelSet.ZoomLevel03.CustomStyles.Add(occludedFrontLineStyle);
            inMemoryFeatureLayerOccludedFront.ZoomLevelSet.ZoomLevel03.ApplyUntilZoomLevel = ApplyUntilZoomLevel.Level20;
            featureLayers.Add(inMemoryFeatureLayerOccludedFront);
            // Add features which present the occluded points.
            LineShape lineShape9 = new LineShape(File.ReadAllText(Path.Combine(baseDirectory, "CustomStyles", "OccludedFront9.txt")).Trim());
            inMemoryFeatureLayerOccludedFront.InternalFeatures.Add(new Feature(lineShape9));
            LineShape lineShape10 = new LineShape(File.ReadAllText(Path.Combine(baseDirectory, "CustomStyles", "OccludedFront10.txt")).Trim());
            inMemoryFeatureLayerOccludedFront.InternalFeatures.Add(new Feature(lineShape10));
            LineShape lineShape11 = new LineShape(File.ReadAllText(Path.Combine(baseDirectory, "CustomStyles", "OccludedFront11.txt")).Trim());
            ...
            pressureFeatureLayer.ZoomLevelSet.ZoomLevel03.CustomStyles.Add(pressureValueStyle);
            pressureFeatureLayer.ZoomLevelSet.ZoomLevel03.ApplyUntilZoomLevel = ApplyUntilZoomLevel.Level20;
            featureLayers.Add(pressureFeatureLayer);

            // Add features which present the "Pressure" points.
            string[] pressurePointStr = File.ReadAllLines(Path.Combine(baseDirectory, "Pressure.txt"));
        ...
        private static ValueStyle GetIconStyle()
        {
            ...
            {
                // Get the file path name from its relative path.
                string imagePath = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", "Images", $"vehicle{i.ToString(CultureInfo.InvariantCulture)}.png");

                IconStyle iconStyle = new IconStyle(imagePath, "Type", new GeoFont("Arial", 12, DrawingFontStyles.Bold), new GeoSolidBrush(GeoColors.Black));
